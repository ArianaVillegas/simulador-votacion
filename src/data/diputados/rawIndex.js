...
export const diputadosRaw = {
    amazonas, ancash, apurimac, arequipa, ayacucho, cajamarca, callao, cusco,
    huancavelica, huanuco, ica, junin, 'la-libertad': laLibertad, lambayeque,
    lima, 'lima-provincias': limaProvincias, loreto, 'madre-de-dios': madreDeDios,
    moquegua, pasco, piura, puno, 'san-martin': sanMartin, tacna, tumbes,
    ucayali, 'peruanos-extranjero': peruanosExtranjero
};

export default diputadosRaw;
